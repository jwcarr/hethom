...
In contrast with Transmission-only, where only one chain remained expressive into Epoch~III, in Transmission~+ Communication, five chains (O,~P, Q, R, and~T) remained expressive, six if you include Chain~B, whose <sol> spelling does find its origin in the <soe> spelling from the seed orthography.
