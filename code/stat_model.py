...
def unpaired_t_test(condition1, condition2, params):
	condition1 = np.array(condition1)
	condition2 = np.array(condition2)
	with pm.Model() as model:
		μ1 = pm.Normal('μ1', mu=500, sigma=100)
		σ1 = pm.Exponential('σ1', lam=0.01)
		x1 = pm.Normal('x1', mu=μ1, sigma=σ1, observed=condition1)
		μ2 = pm.Normal('μ2', mu=200, sigma=100)
...
if __name__ == '__main__':
	...
	condition1 = generate_systems(10, 500, 50)
	condition2 = generate_systems(10, 500, 50)
